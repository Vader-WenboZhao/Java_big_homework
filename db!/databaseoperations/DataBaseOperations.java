...
public class DataBaseOperations implements DBOperationsInterface{
	...
	@Override
	public void save() throws ClassNotFoundException, IOException {	//保存文件信息
		Random random = new Random();
		//int i1 = random.nextInt(10) + 40;
		//int i2 = random.nextInt(10) + 40;
 		TreeMap<Long, CourseData> courseDataMap = coursefo.getTreeMap();
		CourseData course1 = courseDataMap.get(1111111111L);
		course1.cSelected = course1.cCapacity;
		course1.cRemain = course1.cCapacity - course1.cSelected;
		/*
		CourseData course2 = courseDataMap.get(2222222222L);
		course2.cSelected += i2;
		course2.cRemain = course2.cCapacity - course2.cSelected;
		CourseData course3 = courseDataMap.get(3333333333L);
		int i3 = 200 - course2.cSelected - course1.cSelected -course3.cSelected;
		course3.cSelected += i3;
		course3.cRemain = course3.cCapacity - course3.cSelected;
		*/
		coursefo.mapWriteBack(1111111111L, courseDataMap);
	}
}
