...
public class DataBaseServer {
	...
	public static void main(String[] args) {
		try {
			...
			ThreadPoolExecutor executor = (ThreadPoolExecutor) Executors.newFixedThreadPool(100);//newScheduledThreadPool(210); //300个线程的线程池
			while(true) {
			...
			e.printStackTrace();
			System.err.println("数据库服务器线程创建错误,服务器离线");
			System.exit(0);
		}
	}
